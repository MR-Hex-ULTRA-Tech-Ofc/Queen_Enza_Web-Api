...
import type { EnzaWebEventEmitter, Chat, ConnectionState, Contact, GroupMetadata, PresenceData, WAMessage, WAMessageCursor, WAMessageKey } from '../Types'
...
export type EnzaWebInMemoryStoreConfig = {
...
export default (
	{ logger: _logger, chatKey }: EnzaWebInMemoryStoreConfig
) => {
	...
	/**
	 * binds to a EnzaWebEventEmitter.
	 * It listens to all events and constructs a state that you can query accurate data from.
	 * Eg. can use the store to fetch chats, contacts, messages etc.
	 * @param ev typically the event emitter from the socket connection
	 */
	const bind = (ev: EnzaWebEventEmitter) => {
