...
export type EnzaWebEvent = keyof EnzaWebEventMap

export interface EnzaWebEventEmitter {
	on<T extends keyof EnzaWebEventMap>(event: T, listener: (arg: EnzaWebEventMap[T]) => void): void
    off<T extends keyof EnzaWebEventMap>(event: T, listener: (arg: EnzaWebEventMap[T]) => void): void
    removeAllListeners<T extends keyof EnzaWebEventMap>(event: T): void
	emit<T extends keyof EnzaWebEventMap>(event: T, arg: EnzaWebEventMap[T]): boolean
}