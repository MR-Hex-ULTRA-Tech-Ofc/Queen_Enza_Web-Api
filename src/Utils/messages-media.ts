...
import { EnzaWebEventMap, DownloadableMessage, MediaConnInfo, MediaDecryptionKeyInfo, MediaType, MessageType, SocketConfig, WAGenericMediaMessage, WAMediaUpload, WAMediaUploadFunction, WAMessageContent } from '../Types'
...
export const decodeMediaRetryNode = (node: BinaryNode) => {
	...
	const event: EnzaWebEventMap['messages.media-update'][number] = {
		key: {
			id: node.attrs.id,
